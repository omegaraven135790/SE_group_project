...
team members:
  Doshyant raj Thiruchelvan(0375465), group leader
...
we have split our sdlc work into the following sections but all tasks after analysis are interleaved:
...
analysis:
- write project vision and justification document
...
implementation:
- use the class diagram,use case diagram,wireframe and user requirements to develop the prototype
- test each part of prototype as its being developed
